...
class CookiePage extends StatelessWidget {
        ...
        children: <Widget>[
          ...
          Container(
            ...
            primary: false,
              ...
              _buildCard('Cookie choco', '\$2.99', 'assets/cookiechoco.jpg',false,false,context)
              ],
            )
  ...
  Widget _buildCard(String name,String price,String imgPath,bool added,
    ...
    return Padding(padding: EdgeInsets.only(top: 5.0,left: 5.0,right: 5.0,bottom: 5.0),
    child: InkWell(
      onTap: ()
      {
